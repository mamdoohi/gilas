            ...
            <tr>
                ...
                <td id="grid-align">
                    ...
                    if ($weblink['Weblink']['published']) {
                        ...
                        echo $this->Form->postLink($this->Html->image($src), array('action' => 'unPublishWebLink', $weblink['Weblink']['id'], 'admin' => TRUE), array('escape' => false));
                    } else {
                        $src = 'back-end/bootstrap/publish_x.png';
                        echo $this->Form->postLink($this->Html->image($src), array('action' => 'publishWebLink', $weblink['Weblink']['id'], 'admin' => TRUE), array('escape' => false));
                    }
                    ?>
                </td>
