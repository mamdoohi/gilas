...
<?php
echo $this->Html->link('افزودن مجموعه گالری', array('action' => 'add'), array('class' => 'btn btn-primary btn-large'));
    ...
    <table class="table table-bordered table-striped">
        ...
        foreach ($galleryCategories as $galleryCategory):
            ...
            <tr>
                ...
                <td><?php echo $galleryCategory['GalleryCategory']['imageCount']; ?></td>
                <td id="grid-align">
                    <?php
