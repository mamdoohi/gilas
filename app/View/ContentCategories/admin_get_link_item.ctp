...
<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <td><a onclick="$('#<?php echo $this->passedArgs['elmID'] ?>').val('<?php echo $this->Html->url(array('action' => 'view',$category['ContentCategory']['id'],'admin' => false),true); ?>');$.modal.close();"><?php echo $category['ContentCategory']['name'] ?></a></td>
    </tr>
    <?php endforeach;?>
</table>
<div class="pagenavi">
